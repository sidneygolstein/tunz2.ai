    ...
    instructions = (
        f"""
            ...
            - The json file is composed as follows:
                ...
                - For the applicant_review key, the value is three paragraphs that give feedback of the interview for the applicant. However, if the mean of the criteria_score values of the applicant during the interview is between 0/10 and 2.5/10, please don’t give any feedback to the applicant and only write a note to let the applicant know that not enough data was provided to provide a meaningful personalized feedback to them. If the mean of the criteria_score  values of the applicant during the interview is above 2.5/10, the value is three paragraphs that give feedback of the interview for the applicant. The feedback needs to be clear and concise, with each paragraph providing specific information to the applicant about his performance during the interview. Always write before providing the feedback:
		            ...
		            - The First paragraph: max 60 words overall assessment of how the applicant performed during the interview. Please be “positive” in the tone and assessment & avoid giving too much details or negative feedback to the applicant. The objective is to highlight what the applicant did well.
