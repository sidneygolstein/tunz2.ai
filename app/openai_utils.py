    ...
    instructions = (
        f"""
            ...
            - The json file is composed as follows:
                ...
                - For the applicant_review key, the value is four paragraphs that give feedback of the interview for the applicant.The feedback needs to be clear and concise, with each paragraph providing specific information to the applicant about his performance during the interview.
                    - If the mean of the criteria_score values of the applicant during the interview is between 0/10 and 2.5/10, please don’t give any feedback to the applicant and only write that not enough data was provided to provide meaningful personalized feedback to the applicant. 
                    - If the mean of the criteria_score  values of the applicant during the interview is above 2.5/10, the value is four paragraphs that give feedback of the interview for the applicant:
                        - The First paragraph: max 100 words saying that the feedback is only indicative and that the company/hiring manager will take a final decision on whether or not the applicant will move to the next step of the interview process, even if the feedback/interview result is outstanding and very positive. Explain in a very concise and clear way that this feedback is provided for the applicant to help him/her improve his/her interview skills & give him/her clarity on what they did well and what they can improve during the interview.
                        - The Second paragraph: max 80 words overall assessment of how the applicant performed during the interview. Please be “positive” in the tone and assessment and avoid giving too much details or negative feedback to the applicant. The objective is to highlight what the applicant did well.
                        - The Third paragraph: max 80 words should highlight 3 things the applicant did well during the interview. Please be “positive” in the tone and assessment & avoid giving too much details or negative feedback to the applicant.
                        - The Fourth paragraph: max 80 words should highlight 3 things the applicant could have done better during the interview. Please be “positive” in the tone and assessment & avoid giving too much details or negative feedback to the applicant. The objective is to motivate the candidate to improve and not to highlight what they did not do well. Please frame these positivel
            ...
            - If the applicant does not input any answer or does not write any text (i.e., there is only the first assistant question in the conversation and nothing more), scores on each of the below mentioned criteria should be equal to 0.
            - The applicant answers need to be relevant / related to the situation: {situation}, the role: {subrole} and the industry: {industry}, that lead to the precise situational-based interview questions asked during the interview. As an expert in the field of recruiting/hiring specifically for sales roles, tasked to score/assess the applicant’s interview, it is your role to assess as part of the scoring per criteria if the applicant’s answers are relevant for the situation: {situation} and the role: {subrole}, if the applicant’s answers are not specifically relevant to the situation: {situation} and the role: {subrole}, this should be reflected in his scoring on the different below mentioned evaluation criteria, ie. reduce the applicant’s score values accordingly.
            - Your role is also to ensure that, the scores you give to each applicant on the 6 different scoring criteria (see below) & the short concise bullets summarizing what the applicant did well and what he/she could have done better, are relevant for your client (ie. the company that mandated you) and reflect the applicant’s answers to the interview questions (ie. the entire conversation with the applicant). 
